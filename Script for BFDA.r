...
Models = "NLP"    # Other prior distributions: "t-distribution"  , "Normal"  , "NLP"
...
# Design priors
Model_d = "NLP"   # Alternative models: "t-distribution" "Normal" "NLP"
location_d = 0    # location parameter
scale_d = .3      # scaling parameter or the standard deviation for normal model
